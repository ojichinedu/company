...
if(isset($_POST['withdraw'])){
  ...
  $method = $_POST['method'];
  $message = "from:".$client."\n"."name:".$clientName."\n"."Requesting Withdrawal Amount:".$amount."Through :".$method;
 //The content-type header must be set when sending HTML email
  $headers = "MIME-Version: 1.0" . "\r\n";
  $headers = "Content-type:text/html;charset=UTF-8" . "\r\n";
  $headers = "From:" . $from;
  if(mail($to,$amount,$message, $headers)) {
     echo '<script>alert("Withdrawal request has beemn sent.");</script>';
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 align="center" class="card-title"><span style="font-size:22px;color:black;margin-right:2px;">Make A Withdrawal</span></h5>
              <hr>
...
<div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="method" name="method"
                                        placeholder="Withdrawal Method" required> 
                                </div>
<br>
...
<div class="form-group" align="center">
    ...
    <input type="submit" name="withdraw" class="btn btn-primary" id="withdraw" value="Request Withdrawal">
</div>
