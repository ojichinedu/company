    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Referral Code: <span style="color:green;font-size:20px;"><?php echo $row['referral'];?></span></h5>
              <h2 class="card-title">Referral Bonus: <span style="color:green;font-size:20px;">$<?php echo $row['bonus'];?></span></h2>
              <p class="card-title">You Have <span style="color:green;font-size:20px;"><?php echo $row['referrals']; ?></span> Active Referrals.</p>
            </div>
          </div>
