...
<body>
  ...
  <main id="main">
    ...
    <section id="pricing" class="pricing">
      ...
      <div class="col-lg-12">
<p><b>In today's online world, knowing there is someone you can count on regarding your finances is crucial. No matter where you are in life, you can depend on our investment management expertise to build a plan that can help you achieve financial security.
We offer automatically rebalanced, smart portfolios. Built to help you reach your goals and invest in what matters. Our portfolios are carefully designed to put your needs front and center.
We also have offer a wealth manager that can help you prioritize your goals like saving for college and retirement, create a plan for reaching them, and provide portfolio recommendations.

We’ll help you tailor a portfolio designed to meet your investment goals utilizing a variety of investment products including stocks, municipal bonds, corporate bonds, exchange-traded funds (ETFs) and new issues. We enable you to combine a wide variety of investment options into a single account allowing you to see your total investment performance in a single statement.</p>
<br>
</div>
<div class="col-lg-12">
<h4>Portfolio Management</h4>
<p>Portfolio management is the process of picking the type and mix of investments, to achieve a specific investment goal, then monitoring and adjusting those investments over time. We help you meet your longer-term goals with an investment strategy that’s specifically designed for you. And we’re transparent about the investment decisions we make for you because we believe an informed investor is a better investor and a happier client. Much like a tailor who alters the hem, sleeves, and collar of a suit to fit an individual's proportions, we take a variety of factors into account to create a portfolio tailored to your needs. At Definance, we go beyond just recommending an asset or investment strategy. We stay in touch with our clients as their needs evolve and market conditions deviate. We are invariably transparent about the investment decisions we recommend to investors because we believe an informed and well-educated investor is a better and happier client.
</p>
<br>
<h4>Our Approach to
Portfolio management</h4>
<p>
  <h5 style="color:green;">Flexible</h5>
  <p>Every investor has unique needs. Some want growth or cash flow, others want to avoid certain industries or companies. At Aspen, investment management starts with you. We take the time to understand your financial goals and needs. Only then can we create a tailored portfolio recommendation that focuses on your goals and adapts as the market changes.

</p>
<br>
<h5 style="color:green;">Comprehensive</h5>
<p>Many investors especially Americans, have an incomplete view of investing—focusing chiefly on US stocks and Assets. However, the US makes up only about half of the value of the world stock market. That’s important because some of the largest, fastest-growing, best-run companies are outside the US. With a comprehensive, global focus, you can increase diversification and take advantage of opportunities many investment managers miss.
</p>
<br>
<h5 style="color:green;">Discipline</h5>
<p>You deserve a manager who does more than just pick stocks. DFG meticulously analyzes markets, identifies the most attractive investment categories, and then chooses individual stocks, bonds, or other securities for your portfolio.

</p>
<br>
<h5 style="color:green;">Dynamic</h5>
<p>Many investment advisers stick to one style of investing, such as growth, momentum, or value. But what happens when their style falls out of favor? We at Definance, prefer a flexible approach that can adapt to our forward-looking market views.
