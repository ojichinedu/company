  ...
  <main id="main">
    ...
    <section  id="pricing" class="pricing">
      <div class="container" data-aos="fade-up">
        <h4>Philanthropy</h4>
      <div class="col-lg-12">
<p><b>When you’re ready to establish your philanthropic plan, we can help you identify the approach and structure that’s right for you.
Giving back is often an essential part of a life plan as well as a financial plan. It’s why we offer a wide range of philanthropic services and advice. We can help you articulate the impact you want to have and the amount you want to give, and identify the structure that’s right for you. No matter where you are in your giving journey, our goal is always the same to help you create the impact you want to have in a way that works well with your overall financial plan.</b></p>


<p ><b>Philanthropy can be one of life’s most rewarding and meaningful endeavors. When done well, it creates tremendous, positive change in the lives of others. Whether you’re just beginning your philanthropic journey, or are a highly sophisticated donor, we are here to help you achieve the impact you envision.To help you practice strategic philanthropy, we provide thought leadership pieces, research and advice around many aspects of giving. If you have more complex philanthropic goals, Dfinance can guide you through issues such as engaging the next generation and deciding between charitable giving vehicles.</b></p>
<p ><b>Starting with your philanthropic goals: No matter how simple or complex your giving strategy may be, articulating your goals will help you get the most out of your philanthropy. Once you have a vision in place, we’ll help you think about what approaches are most effective in making an impact, aiming to bring efficiency and effectiveness to your charitable giving. </b></p>
<p ><b>Engaging your family: Philanthropy can be a good way to establish strong family values for your children. And if a philanthropic legacy is one of your goals, you may wish to involve your family. For those with more complex issues, a definance can help facilitate conversations and approaches to bringing the family together. We can help you establish philanthropic goals and practices that create excitement and enthusiasm so you can make an impact now, and create a legacy that could last generations.We can also connect you to the right people like-minded peers and organizations that can be a resource for best practices, collaboration and opportunities for impact.</b></p>
<br>
<h4>Donor Advised Funds</h4>
<p><b>Making an impact starts with choosing the right structure for your philanthropic giving. A DAF can be a good alternative to setting up a private foundation.</b></p>
</div>
